...
eval (moon shell-completion --shell elvish)
eval (taws completion elvish)
eval (purple --completions elvish)
eval (sharedserver completion elvish)
eval (unifly completions elvish)
eval (rvpm completion elvish)
